A **Hermitian inner product** $\langle\cdot,\cdot\rangle$ on a complex [[vector space]] $V$ is a [[multilinear|bilinear]] form on $V$ that is antilinear in the second slot. That is,
